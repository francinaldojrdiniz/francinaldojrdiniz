...
- 📄 **Pipeline de extração de documentos fiscais** com OCR em nuvem + processamento de NFe XML: fila RabbitMQ, validação pós-processamento — reduziu digitação manual em cargas recorrentes.
